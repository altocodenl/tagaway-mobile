                           ...
                           RoundedButton(
                              ...
                              onPressed: () {
                                 AuthService.instance.login (
                                    ...
                                    if (value == 200) {
                                       if (
                                          Platform.isIOS     && flag.permissionLevel == 'denied' ||
                                          Platform.isAndroid && flag.permissionLevel == 'denied' && (recurringUserLocal == false || recurringUserLocal == null)
                                       ) {
                                          ...
                                          return SnackBarGlobal.buildSnackBar (context, 'Login successful, need permissions', 'yellow');
                                       }
                                       else if (flag.permissionLevel == 'granted' || flag.permissionLevel == 'limited') {
                                          // TODO: add proper routing here
                                          // Navigator.pushReplacement (context, MaterialPageRoute (builder: (BuildContext context) => GridPage ()));
                                          return SnackBarGlobal.buildSnackBar (context, 'Login successful, permissions granted!', 'green');
                                       }
                                       else {
                                          // TODO: add proper routing here
                                          //Navigator.pushReplacementNamed (context, PhotoAccessNeeded.id, arguments: PermissionLevelFlag (permissionLevel: value));
                                          return SnackBarGlobal.buildSnackBar (context, 'Login successful, need permissions', 'green');
                                       }
                                    }
                                 });
                              },
